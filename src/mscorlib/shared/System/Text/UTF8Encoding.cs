    ...
    public class UTF8Encoding : Encoding
    {
        ...
        */
        ...
        internal sealed class UTF8EncodingSealed : UTF8Encoding
        {
            ...
            public override ReadOnlySpan<byte> Preamble => _emitUTF8Identifier ? PreambleConstant : Array.Empty<byte>();
        }
        ...
        internal static ReadOnlySpan<byte> PreambleConstant => new byte[3] { 0xEF, 0xBB, 0xBF };
        ...
        public override ReadOnlySpan<byte> Preamble =>
            ...
            _emitUTF8Identifier ? PreambleConstant :
            Array.Empty<byte>();
